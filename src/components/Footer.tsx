...
const footerNavigation = {
  servicios: [
    ...
    { name: "Software a Medida", href: "/servicios#software" },
    { name: "Apps Moviles", href: "/servicios#apps" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-6 text-gray-300 text-sm leading-relaxed">
              Desarrollo de aplicaciones web y software a medida para el sector salud.
              Soluciones personalizadas con licencia completa en propiedad.
            </p>
            {/* Redes sociales */}
            <div className="flex space-x-4 mt-6">
              <a
                ...
                className="text-gray-300 hover:text-[#71C648] transition-colors"
              >
          ...
          {/* Servicios */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#71C648]">Servicios</h3>
          ...
          {/* Empresa */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#71C648]">Empresa</h3>
            <ul className="space-y-3">
          ...
          {/* Contacto */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#71C648]">Contacto</h3>
            <ul className="space-y-3 text-sm text-gray-300">
              <li className="flex items-start">
                ...
                <a href="mailto:info@codeconnect.es" className="hover:text-white transition-colors">
                  info@codeconnect.es
                </a>
              </li>
              <li className="flex items-start">
