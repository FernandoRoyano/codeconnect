    ...
    <div className={`flex flex-col ${className}`}>
      <div className="flex items-center">
        ...
        <span
          ...
          style={{ color: blueColor, fontFamily: "Helvetica, Arial, sans-serif" }}
        >
          Code
        </span>
      ...
      {showTagline && (
        <span
          className="text-sm md:text-base tracking-wide mt-1"
